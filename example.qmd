...
```{python}
#| include-from: test/snippets/capitalize.sh
#| source-lang: bash
#| start-line: 2
#| end-line: 7
...
::: {include-from=test/snippets/capitalize.scala start-line=1 end-line=17 code-line-numbers="true"}
...
We can use `filename` either within a python chunk or in pandoc div with `include-from` attribute to include a code filename.
...
::: {include-from=test/snippets/capitalize.lua code-line-numbers="true" filename=capitalize.lua}
